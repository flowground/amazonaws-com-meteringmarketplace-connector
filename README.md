# ![LOGO](logo.png) AWSMarketplace Metering MSP Connector

## Description

A generated MSP connector for the AWSMarketplace Metering API (version 2016-01-14).
...
flowground :- Telekom iPaaS / amazonaws-com-meteringmarketplace-connector<br/>
